...
response = WS.sendRequest(findTestObject('Credits/Post/Create_Credits neg2'))

WS.verifyResponseStatusCode(response, 400, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Credits/Post/Create_credits-neg1'))

WS.verifyResponseStatusCode(response, 404, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Credits/Post/Create_credits-neg3'))
