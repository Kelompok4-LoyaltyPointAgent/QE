...
response = WS.sendRequest(findTestObject('Package/Post/Create_Packages - negative1'))

WS.verifyResponseStatusCode(response, 404, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Package/Post/Create_Packages - Negative2'))
